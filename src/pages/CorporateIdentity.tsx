      ...
      >
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { title: "Company Vision", desc: "Our vision to be a global leader in composite reinforcement solutions" },
              { title: "Core Values", desc: "Innovation, quality, sustainability, and customer partnership" },
              { title: "Industry Leadership", desc: "25+ years of expertise in GFRP manufacturing and innovation" },
              { title: "Global Presence", desc: "Serving clients worldwide with advanced GFRP solutions" }
            ].map((item, index) => (
              <motion.div 
                key={index}
                initial={{ opacity: 0, y: 30 }}
