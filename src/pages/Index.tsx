...
const sliderData = [
  ...
  },
  {
    ...
    description: 'Cutting-edge composite rebars offering exceptional corrosion resistance and structural integrity for critical infrastructure',
    images: [applicationsShowcase, gfrpReinforcement, materialsShowcase],
    badge: 'Technology'
  },
  {
    title: 'VEGNAR Excellence in Engineering',
    description: 'Decades of expertise in composite material science delivering world-class GFRP solutions for global construction projects',
    images: [vegnarMilestones, companyTeam, coreValues],
    badge: 'Excellence'
  },
  {
    title: 'Premium GFRP Product Portfolio',
    description: 'Comprehensive range of high-performance glass fiber reinforced polymer products engineered for demanding applications',
            ...
            >
              ...
              <div className="relative h-full flex items-center justify-center">
                <div className="text-center max-w-5xl px-6 animate-fade-in">
                  <Badge variant="secondary" className="mb-6 bg-primary/30 text-white border-primary/50 text-lg px-4 py-2">
                    {slide.badge}
                  </Badge>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <Button size="lg" className="bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 text-white border-2 border-primary/50 text-lg px-8 py-4 shadow-2xl font-bold">
                      Explore Gallery
                    </Button>
                    <Button size="lg" className="bg-gradient-to-r from-secondary to-secondary/80 hover:from-secondary/90 hover:to-secondary/70 text-white border-2 border-secondary/50 text-lg px-8 py-4 shadow-2xl font-bold">
                      Read Blog
                    </Button>
                    <Button size="lg" className="bg-gradient-to-r from-green-600 to-green-800 hover:from-green-700 hover:to-green-900 text-white border-2 border-green-500 text-lg px-8 py-4 shadow-2xl font-bold">
                      Get Quote
                    </Button>
                  </div>
                </div>
            ...
            {sliderData.map((_, index) => (
              ...
              >
                <div 
                  ...
                  style={{
                    animation: index === currentSlide ? 'fillCapsule 5s linear infinite' : 'none'
                  }}
                />
              </button>
            ))}
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center mb-20">
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-primary/10 to-secondary/10 px-4 py-2 rounded-full border border-primary/20 mb-6">
              ...
              <span className="text-sm font-semibold text-primary">Industry Pioneer</span>
            </div>
            <h2 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-gray-900 via-primary to-secondary bg-clip-text text-transparent mb-8 leading-tight">
              VEGNAR GFRP
              <br />
              <span className="text-4xl md:text-5xl">Engineering Excellence</span>
            </h2>
            <p className="text-xl text-gray-600 leading-relaxed max-w-2xl mx-auto">
              Pioneering the future of construction with revolutionary Glass Fiber Reinforced Polymer technology. 
              Where innovation meets uncompromising quality.
            </p>
          </div>
            ...
            <div className="group relative">
              ...
              <Card className="relative bg-white/80 backdrop-blur-sm border-0 shadow-2xl rounded-3xl p-8 group-hover:shadow-3xl transition-all duration-500 group-hover:-translate-y-2">
                ...
                <CardHeader className="pb-6">
                  ...
                  <CardTitle className="text-2xl font-bold text-gray-900">Corrosion Immunity</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600 mb-6 leading-relaxed">
                    Complete resistance to chemical attack, saltwater corrosion, and environmental degradation. 
                    Perfect for marine structures and harsh environments.
                  </p>
                  <div className="flex items-center gap-3">
                    <div className="text-3xl font-black bg-gradient-to-r from-primary to-primary/80 bg-clip-text text-transparent">100%</div>
                    <div className="text-sm font-semibold text-gray-500 uppercase tracking-wide">Corrosion Free</div>
                  </div>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="group relative">
              ...
              <Card className="relative bg-white/80 backdrop-blur-sm border-0 shadow-2xl rounded-3xl p-8 group-hover:shadow-3xl transition-all duration-500 group-hover:-translate-y-2">
                ...
                <CardHeader className="pb-6">
                  ...
                  <CardTitle className="text-2xl font-bold text-gray-900">Superior Strength</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600 mb-6 leading-relaxed">
                    High tensile strength comparable to steel while being significantly lighter. 
                    Reduces structural dead load and transportation costs.
                  </p>
                  <div className="flex items-center gap-3">
                    <div className="text-3xl font-black bg-gradient-to-r from-secondary to-secondary/80 bg-clip-text text-transparent">75%</div>
                    <div className="text-sm font-semibold text-gray-500 uppercase tracking-wide">Lighter</div>
                  </div>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="group relative">
              ...
              <Card className="relative bg-white/80 backdrop-blur-sm border-0 shadow-2xl rounded-3xl p-8 group-hover:shadow-3xl transition-all duration-500 group-hover:-translate-y-2">
                ...
                <CardHeader className="pb-6">
                  ...
                  <CardTitle className="text-2xl font-bold text-gray-900">Smart Properties</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600 mb-6 leading-relaxed">
                    Non-magnetic, non-conductive, and electromagnetic transparent properties. 
                    Perfect for MRI facilities and sensitive installations.
                  </p>
                  <div className="flex items-center gap-3">
                    <div className="text-3xl font-black bg-gradient-to-r from-emerald-500 to-emerald-600 bg-clip-text text-transparent">EMI</div>
                    <div className="text-sm font-semibold text-gray-500 uppercase tracking-wide">Transparent</div>
                  </div>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">
                Advanced GFRP
                <br />
                <span className="bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Specifications</span>
              </h2>
              
              <p className="text-xl text-gray-300 mb-12 leading-relaxed">
                Engineered to exceed industry standards with superior mechanical properties and long-term durability.
              </p>
              ...
              <div className="grid grid-cols-2 gap-6 mb-12">
                <div className="group relative">
                  ...
                  <div className="relative bg-white/10 backdrop-blur-sm border border-white/20 p-6 rounded-2xl group-hover:bg-white/15 transition-all duration-300">
                    ...
                    <div className="text-sm font-semibold text-gray-300 uppercase tracking-wide">MPa Tensile Strength</div>
                  </div>
                </div>
                ...
                <div className="group relative">
                  ...
                  <div className="relative bg-white/10 backdrop-blur-sm border border-white/20 p-6 rounded-2xl group-hover:bg-white/15 transition-all duration-300">
                    ...
                    <div className="text-sm font-semibold text-gray-300 uppercase tracking-wide">GPa Elastic Modulus</div>
                  </div>
                </div>
                ...
                <div className="group relative">
                  ...
                  <div className="relative bg-white/10 backdrop-blur-sm border border-white/20 p-6 rounded-2xl group-hover:bg-white/15 transition-all duration-300">
                    ...
                    <div className="text-sm font-semibold text-gray-300 uppercase tracking-wide">Years Service Life</div>
                  </div>
                </div>
                ...
                <div className="group relative">
                  ...
                  <div className="relative bg-white/10 backdrop-blur-sm border border-white/20 p-6 rounded-2xl group-hover:bg-white/15 transition-all duration-300">
                    <div className="text-3xl font-black text-purple-400 mb-2">-40°C</div>
                    <div className="text-sm font-semibold text-gray-300 uppercase tracking-wide">to +80°C Range</div>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4 group">
                  <div className="w-8 h-8 bg-gradient-to-br from-primary to-primary/80 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                    <CheckCircleIcon className="h-5 w-5 text-white" />
                  </div>
                  <span className="text-lg font-semibold text-white">ASTM D7957 Compliant</span>
                </div>
                <div className="flex items-center gap-4 group">
                  <div className="w-8 h-8 bg-gradient-to-br from-secondary to-secondary/80 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                    <CheckCircleIcon className="h-5 w-5 text-white" />
                  </div>
                  <span className="text-lg font-semibold text-white">ACI 440.1R Certified</span>
                </div>
                <div className="flex items-center gap-4 group">
                  <div className="w-8 h-8 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                    <CheckCircleIcon className="h-5 w-5 text-white" />
                  </div>
                  <span className="text-lg font-semibold text-white">ISO 9001:2015 Quality</span>
                </div>
              </div>
            </div>
              ...
              <div className="relative overflow-hidden rounded-3xl">
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-4">
                    <div className="text-white font-semibold text-lg">Advanced Composite Technology</div>
                    <div className="text-gray-300 text-sm mt-1">Precision-engineered for optimal performance</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center mb-20">
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-500/10 to-purple-500/10 px-4 py-2 rounded-full border border-blue-500/20 mb-8">
              ...
              <span className="text-sm font-semibold text-blue-600">Global Applications</span>
            </div>
            ...
            <h2 className="text-5xl md:text-6xl font-bold mb-8 leading-tight">
              ...
              <br />
              <span className="text-4xl md:text-5xl text-gray-700">Applications</span>
            </h2>
            
            <p className="text-xl text-gray-600 leading-relaxed">
              Trusted by engineers worldwide for critical infrastructure and specialized construction projects 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="group relative">
              ...
              <Card className="relative bg-white/80 backdrop-blur-sm border-0 shadow-2xl rounded-3xl p-8 text-center group-hover:shadow-3xl transition-all duration-500 group-hover:-translate-y-3">
                ...
                <div className="pt-8">
                  <CardTitle className="text-2xl font-bold text-gray-900 mb-4">Marine Structures</CardTitle>
                  <p className="text-gray-600 leading-relaxed mb-6">
                    Ports, harbors, offshore platforms, and coastal infrastructure requiring superior corrosion resistance.
                  </p>
            ...
            <div className="group relative">
              ...
              <Card className="relative bg-white/80 backdrop-blur-sm border-0 shadow-2xl rounded-3xl p-8 text-center group-hover:shadow-3xl transition-all duration-500 group-hover:-translate-y-3">
                ...
                <div className="pt-8">
                  <CardTitle className="text-2xl font-bold text-gray-900 mb-4">Medical Facilities</CardTitle>
                  <p className="text-gray-600 leading-relaxed mb-6">
                    MRI rooms, hospitals, and electromagnetic sensitive areas requiring non-conductive materials.
                  </p>
            ...
            <div className="group relative">
              ...
              <Card className="relative bg-white/80 backdrop-blur-sm border-0 shadow-2xl rounded-3xl p-8 text-center group-hover:shadow-3xl transition-all duration-500 group-hover:-translate-y-3">
                ...
                <div className="pt-8">
                  <CardTitle className="text-2xl font-bold text-gray-900 mb-4">Chemical Plants</CardTitle>
                  <p className="text-gray-600 leading-relaxed mb-6">
                    Processing facilities, storage tanks, and corrosive environments demanding chemical resistance.
                  </p>
            ...
            <div className="group relative">
              ...
              <Card className="relative bg-white/80 backdrop-blur-sm border-0 shadow-2xl rounded-3xl p-8 text-center group-hover:shadow-3xl transition-all duration-500 group-hover:-translate-y-3">
                ...
                <div className="pt-8">
                  <CardTitle className="text-2xl font-bold text-gray-900 mb-4">Infrastructure</CardTitle>
                  <p className="text-gray-600 leading-relaxed mb-6">
                    Bridges, tunnels, highways, and critical infrastructure projects requiring long-term durability.
                  </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-secondary-foreground/90 mb-8">
                State-of-the-art manufacturing facilities with advanced pultrusion technology, 
                ensuring consistent quality and superior performance in every GFRP product.
              </p>
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div>
                  <div className="text-3xl font-bold text-secondary-foreground">5000+</div>
                ...
                <div>
                  ...
                  <div className="text-secondary-foreground/80">Countries Served</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-secondary-foreground">ISO</div>
                  <div className="text-secondary-foreground/80">Certified Quality</div>
                </div>
              </div>
            </div>
          </div>
