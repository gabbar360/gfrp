...
const companyValues = [
  {
    ...
    description: 'Pioneering advanced GFRP technology through continuous research and development in composite materials',
    icon: AcademicCapIcon,
  },
  {
    name: 'Quality Assurance',
    description: 'ISO 9001:2015 certified manufacturing processes with rigorous testing and quality control systems',
    icon: TrophyIcon,
  },
  {
    name: 'Customer Partnership',
    description: 'Collaborative approach with engineers and contractors to deliver optimal GFRP solutions',
    icon: UsersIcon,
  },
  {
    name: 'Sustainable Manufacturing',
    description: 'Environmentally responsible production methods and long-lasting composite material solutions',
...
const companyMilestones = [
  {
    ...
    description: 'Established as a pioneer in advanced composite materials and GFRP technology development',
  },
  {
    year: '2005',
    title: 'Manufacturing Excellence',
    description: 'Launched state-of-the-art pultrusion facility with advanced quality control systems',
  },
  {
    year: '2012',
    title: 'Global Expansion',
    description: 'Extended operations to international markets with enhanced production capacity',
  },
  {
    year: '2018',
    title: 'Technology Leadership',
    description: 'Achieved industry recognition for innovative GFRP reinforcement solutions',
  },
  {
    year: '2023',
    title: 'Sustainable Future',
    description: 'Leading the transition to next-generation sustainable composite reinforcement',
  },
];
...
const technicalCapabilities = [
  {
    ...
    description: 'Continuous fiber reinforcement process ensuring consistent quality and superior mechanical properties',
    icon: CogIcon,
  },
  {
    name: 'Material Testing Laboratory',
    description: 'In-house testing facility for tensile strength, durability, and performance validation',
    icon: BeakerIcon,
  },
  {
    name: 'Quality Control Systems',
    description: 'Comprehensive quality assurance protocols meeting international standards and certifications',
    icon: ShieldCheckIcon,
  },
  {
    name: 'Custom Engineering Solutions',
    description: 'Tailored GFRP products designed for specific application requirements and environments',
    icon: ChartBarIcon,
  },
];
            ...
            <div>
              ...
              <div className="space-y-6 mb-10">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  ...
                  processing, and marine engineering with customized GFRP solutions.
                </p>
              </div>
              ...
              <div className="relative overflow-hidden rounded-3xl">
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-6">
                    <div className="text-white font-bold text-xl mb-2">State-of-the-Art Facility</div>
                    <div className="text-gray-200">Advanced pultrusion technology and quality control</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center mb-20">
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-500/10 to-purple-500/10 px-4 py-2 rounded-full border border-blue-500/20 mb-8">
              ...
              <span className="text-sm font-semibold text-blue-600">Technical Excellence</span>
            </div>
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              Our comprehensive technical capabilities ensure consistent quality and superior 
              performance in every GFRP product we manufacture.
            </p>
          </div>
              ...
              <div key={capability.name} className="group relative">
                ...
                <Card className="relative bg-white/80 backdrop-blur-sm border-0 shadow-2xl rounded-3xl p-8 group-hover:shadow-3xl transition-all duration-500 group-hover:-translate-y-2">
                  <CardHeader className="pb-6">
                    ...
                    <CardTitle className="text-2xl font-bold text-gray-900">{capability.name}</CardTitle>
                  </CardHeader>
                  <CardContent>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center mb-20">
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-emerald-500/10 to-blue-500/10 px-4 py-2 rounded-full border border-emerald-500/20 mb-8">
              ...
              <span className="text-sm font-semibold text-emerald-600">Core Values</span>
            </div>
            ...
            <h2 className="text-5xl font-bold mb-8 leading-tight">
              ...
              <br />
              <span className="text-4xl text-gray-700">Values & Principles</span>
            </h2>
            
            <p className="text-xl text-gray-600 leading-relaxed">
              The fundamental principles that guide our approach to innovation, quality, 
              and customer partnership in the GFRP industry.
            </p>
          </div>
              ...
              <div key={value.name} className="group relative">
                ...
                <Card className="relative bg-white/90 backdrop-blur-sm border-0 shadow-2xl rounded-3xl p-8 text-center group-hover:shadow-3xl transition-all duration-500 group-hover:-translate-y-3">
                  <CardHeader className="pb-6">
                    ...
                    <CardTitle className="text-2xl font-bold text-gray-900">{value.name}</CardTitle>
                  </CardHeader>
                  <CardContent>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center mb-20">
            ...
            <p className="text-xl text-gray-300 leading-relaxed">
              Our track record of excellence in GFRP manufacturing and customer satisfaction
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center group">
              ...
              <div className="text-gray-400">Successful GFRP installations worldwide</div>
            </div>
            ...
            <div className="text-center group">
              ...
              <div className="text-xl font-semibold text-white mb-2">Product Variants</div>
              <div className="text-gray-400">Comprehensive GFRP product range</div>
            </div>
            ...
            <div className="text-center group">
              ...
              <div className="text-xl font-semibold text-white mb-2">Countries Served</div>
              <div className="text-gray-400">Global presence and distribution</div>
            </div>
            ...
            <div className="text-center group">
              ...
              <div className="text-gray-400">Industry leadership and innovation</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="text-xl text-gray-600 leading-relaxed mb-12">
              Experience the VEGNAR difference with superior GFRP solutions tailored to your 
              specific project requirements. Our technical experts are ready to assist you.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Button size="lg" className="bg-primary hover:bg-primary/90 px-10 py-5 text-lg font-semibold">
                Contact Our Experts
                <ArrowRightIcon className="ml-2 h-5 w-5" />
              </Button>
              <Button variant="outline" size="lg" className="px-10 py-5 text-lg font-semibold">
