        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-secondary-foreground/90">
              Real-world applications and success stories of Vegnar GFRP materials in action
            </p>
          </div>
        </div>
      </section>
          ...
          {filteredCaseStudies.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredCaseStudies.map((caseStudy) => (
                <Card key={caseStudy.id} className="bg-card shadow-card hover:shadow-elevated transition-shadow">
                  <CardHeader>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              We'd love to feature your project using Vegnar GFRP materials. Contact us to discuss 
              creating a case study highlighting your innovative application.
            </p>
            <Link to="/contact">
              <Button size="lg">
                Submit Your Project
